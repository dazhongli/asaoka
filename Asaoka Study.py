...
df = ReadRawData.read_xl_file(os.path.join(folder,filename))
...
df = ReadRawData.read_SMM_data_settlement(os.path.join(SMM_path,SMM_filename),sheetname = 1,index_id= [2,3,4,5,6])