...
def plot_raw_data(dfs,df_names,fig_name,ground_level=True):
...
#        ax_settlement.plot(df_date, df_settlement,
#                           marker=(marker_list[index]),markersize=4)
        ax_settlement.plot(df_date, df_settlement,markersize=4)
        #plot at the day-axis
        ax_settlement2.plot(time_incr,df_settlement,'bx',markersize=4,
